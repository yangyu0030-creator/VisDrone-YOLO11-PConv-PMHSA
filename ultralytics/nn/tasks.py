...
from ultralytics.nn.ConvModules import SPDConv
...
def parse_model(d, ch, verbose=True):
    ...
    conv_modules = frozenset({
        C3GhostExp, C3TRExp, C3xExp, FasterBlock, FCM, HGBlockExp, C2fMSBlock,C2fHGBlock,
        LAE, MSBlock, MSCAM, PConv, RFEM, SCConv, SPDConv, C3SCConvExp,C3FasterBlock
    })
    conv_repeat_modules = frozenset({C3GhostExp, C3TRExp, C3xExp, HGBlockExp, C3SCConvExp,C3FasterBlock, C2fMSBlock,C2fHGBlock})
    sppf_modules = frozenset({ASPP, DBS_SPPF, PMHSA, SE_SPPF, SPFF_LSKA})
